...
If you are interested in contributing the package (great!), please read the [contributing](file:///Users/michael.levy/Dropbox/healthcareai-r/docs/dev/CONTRIBUTING.html) guide, and look for [issues with the "help wanted" tag](https://github.com/HealthCatalyst/healthcareai-r/labels/help%20wanted). Feel free to tackle any issue that interests you; those are a few issues that we feel would make a good place to start.
